...
**Date**: 2026-07-20
**Test count**: 828 tests passing, 0 warnings, fmt + clippy clean

---

## v0.8.6 — Stage 3.21–3.43 (typed codegen + runtime checks + literals + ADT structs + field type resolution + field mutation + 6 gate review rounds)
