...
|---|---|
| **Author** | redskaber |
| **Current version** | v0.608.0 (v0.7 Stage 58 — TD-CAST-STR-TO-U8-SLICE FIXED: str::as_bytes real body + infer_cast_kind; TD-STR-INTRINSIC-MARKER-BODIES 3/3 complete; 5436 tests) |
| **Date** | 2026-09-02 |
