...
**Date**: 2026-07-27
**Test count**: 2377 rust tests (with llvm-backend feature) + 5 benchmarks + 5026 conformance tests
...
+9 tests (2324 → 2377 rust tests (with llvm-backend feature)). 0 conformance changes. 0 regressions.
