...
> **Author**: redskaber
> **Date**: 2026-08-25 (last updated Stage 18.259 — TD-UNIFY-ARG-ORDER batch fix)
> **Version**: v0.492.0
> **Status**: Active — all P0/P1 items resolved. TD-TUPLE-CTOR-TYPECK fully RESOLVED (Phases 1+2a+2b+2c, Stages 18.255-18.258). TD-UNIFY-ARG-ORDER (P3) RESOLVED Stage 18.259 — 5 sites in typeck/check.rs (Call arg/return for FnDef, FnPtr, Closure + Switch discr) swapped to correct direction. Remaining: TD-INTRINSIC-OVERUSE Phase 2 (blocked on v0.4+ language features), TD-DROP-MOVED-LOCALS full (deferred to v0.3+ flow-sensitive tracking).
