...
> **Author**: redskaber
> **Version**: 3.22 (effective from Stage 14.51)
> **Supersedes**: v3.21 (preserved verbatim — see §28.5 for v3.21→v3.22 diff)
...
| 进入新阶段 | §13.4, §2, §9, §17 | 阶段开始设计对齐（§13.4, v3.21）+ MUV 拆分 + 集成验证 + 测试矩阵 |
...
process. All agents (main + subagents) must follow it. v3.22 effective
from Stage 14.51.**
