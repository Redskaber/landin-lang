...
> **Author**: redskaber
> **Version**: 3.21 (effective from Stage 6.11)
> **Supersedes**: v3.20 (preserved verbatim — see §28.4 for v3.20→v3.21 diff)
...
process. All agents (main + subagents) must follow it. v3.21 effective
from Stage 6.11.**
