...
> **Status:** v0.16.4 — Stage 0-9.5 complete. v0.2 roadmap done + §17 docs standardization + v0.1 conformance 307/600.
> **2166 tests** + 5 benchmarks + 307 conformance tests. 0 clippy warnings. fmt clean.
...
> - Stage 9: 🔄 In progress (5/12 sub-stages — v0.1 conformance suite expansion: 307/600)
>
...
| 9 | v0.1 conformance suite expansion | 🔄 In progress (5/12) | +65 rust + +299 conformance |
...
```
landin-stage0/
├── Cargo.toml              v0.16.4 (autotests=false — single all_tests target)
├── src/
...
- **Stage 9** 🔄 In progress (v0.1 conformance suite expansion: 307/600 tests, 5/12 sub-stages done — past halfway!)
...
- `docs/develop/v0/api-naming-standard.md` — API naming standard v2.08
...
- `docs/worklog.md` — Worklog mirror (v3.18 §18.4.0) — synced through r188
