...
|---|---|
| **Author** | redskaber |
| **Version** | v0.587.0 (v0.27 Stage 39.2 — fixed scrutinee type resolution for enum match; None variant correctly matches; 5392 tests — Architecture health 9.85/10) |
| **License** | MIT |
