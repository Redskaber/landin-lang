...
> **Status:** v0.16.10 — Stage 0-9.11 complete. v0.2 roadmap done + §17 docs standardization + v0.1 conformance 599/600.
> **2225 tests** + 5 benchmarks + 599 conformance tests. 0 clippy warnings. fmt clean.
...
> - Stage 9: 🔄 In progress (11/12 sub-stages — v0.1 conformance suite expansion: 599/600)
>
...
| 9 | v0.1 conformance suite expansion | 🔄 In progress (11/12) | +124 rust + +591 conformance |
...
```
landin-stage0/
├── Cargo.toml              v0.16.10 (autotests=false — single all_tests target)
├── src/
...
- **Stage 9** 🔄 In progress (v0.1 conformance suite expansion: 599/600 tests, 11/12 sub-stages done — v0.1 release imminent!)
...
- `docs/develop/v0/api-naming-standard.md` — API naming standard v2.14
...
- `docs/worklog.md` — Worklog mirror (v3.18 §18.4.0) — synced through r194
