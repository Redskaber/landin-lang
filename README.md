...
> **Status:** v0.16.1 — Stage 0-9.2 complete. v0.2 roadmap done + §17 docs standardization + v0.1 conformance 98/600.
> **2122 tests** + 5 benchmarks + 98 conformance tests. 0 clippy warnings. fmt clean.
...
> - Stage 9: 🔄 In progress (2/12 sub-stages — v0.1 conformance suite expansion: 98/600)
>
...
| 9 | v0.1 conformance suite expansion | 🔄 In progress (2/12) | +22 rust + +90 conformance |
...
```
landin-stage0/
├── Cargo.toml              v0.16.1 (autotests=false — single all_tests target)
├── src/
...
- **Stage 9** 🔄 In progress (v0.1 conformance suite expansion: 98/600 tests, 2/12 sub-stages done)
...
- `docs/develop/v0/api-naming-standard.md` — API naming standard v2.05
...
- `docs/worklog.md` — Worklog mirror (v3.18 §18.4.0) — synced through r185
