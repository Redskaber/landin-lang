...
> **Status:** v0.16.6 — Stage 0-9.7 complete. v0.2 roadmap done + §17 docs standardization + v0.1 conformance 397/600.
> **2186 tests** + 5 benchmarks + 397 conformance tests. 0 clippy warnings. fmt clean.
...
> - Stage 9: 🔄 In progress (7/12 sub-stages — v0.1 conformance suite expansion: 397/600)
>
...
| 9 | v0.1 conformance suite expansion | 🔄 In progress (7/12) | +85 rust + +389 conformance |
...
```
landin-stage0/
├── Cargo.toml              v0.16.6 (autotests=false — single all_tests target)
├── src/
...
- **Stage 9** 🔄 In progress (v0.1 conformance suite expansion: 397/600 tests, 7/12 sub-stages done — over 2/3!)
...
- `docs/develop/v0/api-naming-standard.md` — API naming standard v2.10
...
- `docs/worklog.md` — Worklog mirror (v3.18 §18.4.0) — synced through r190
