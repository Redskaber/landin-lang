...
> **Status:** v0.16.5 — Stage 0-9.6 complete. v0.2 roadmap done + §17 docs standardization + v0.1 conformance 347/600.
> **2176 tests** + 5 benchmarks + 347 conformance tests. 0 clippy warnings. fmt clean.
...
> - Stage 9: 🔄 In progress (6/12 sub-stages — v0.1 conformance suite expansion: 347/600)
>
...
| 9 | v0.1 conformance suite expansion | 🔄 In progress (6/12) | +75 rust + +339 conformance |
...
```
landin-stage0/
├── Cargo.toml              v0.16.5 (autotests=false — single all_tests target)
├── src/
...
- **Stage 9** 🔄 In progress (v0.1 conformance suite expansion: 347/600 tests, 6/12 sub-stages done)
...
- `docs/develop/v0/api-naming-standard.md` — API naming standard v2.09
...
- `docs/worklog.md` — Worklog mirror (v3.18 §18.4.0) — synced through r189
