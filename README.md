...
> **Status:** v0.17.2 — Stage 0-10.0 complete. CLI --compile/--emit-llvm-ir + runner --mode compile. Parse conformance 600/600 (12% of v0.1 gate).
> **2255 tests** + 5 benchmarks + 600 conformance tests. 0 clippy warnings. fmt clean.
...
| 9 | v0.1 conformance suite expansion | ✅ Complete (12/12) | +134 rust + +592 conformance (600/600) |
...
```
landin-stage0/
├── Cargo.toml              v0.17.2 (autotests=false — single all_tests target)
├── src/
...
- `docs/develop/v0/api-naming-standard.md` — API naming standard v2.17
...
- `docs/worklog.md` — Worklog mirror (v3.18 §18.4.0) — synced through r197
