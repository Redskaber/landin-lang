...
> **Status:** v0.16.2 — Stage 0-9.3 complete. v0.2 roadmap done + §17 docs standardization + v0.1 conformance 177/600.
> **2136 tests** + 5 benchmarks + 177 conformance tests. 0 clippy warnings. fmt clean.
...
> - Stage 9: 🔄 In progress (3/12 sub-stages — v0.1 conformance suite expansion: 177/600)
>
...
| 9 | v0.1 conformance suite expansion | 🔄 In progress (3/12) | +36 rust + +169 conformance |
...
```
landin-stage0/
├── Cargo.toml              v0.16.2 (autotests=false — single all_tests target)
├── src/
...
- **Stage 9** 🔄 In progress (v0.1 conformance suite expansion: 177/600 tests, 3/12 sub-stages done)
...
- `docs/develop/v0/api-naming-standard.md` — API naming standard v2.06
...
- `docs/worklog.md` — Worklog mirror (v3.18 §18.4.0) — synced through r186
