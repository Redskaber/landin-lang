...
> **Status:** v0.17.7 — Stage 0-10.5 in progress. Conformance 959/5000 (19.2% of v0.1 gate).
> **2275 tests** + 5 benchmarks + 959 conformance tests. 0 clippy warnings. fmt clean.
...
> - Stage 10: 🔄 In progress (5/9 sub-stages — v0.1 conformance 959/5000, 19.2% of gate)
>
...
>
> **v0.1 roadmap:** conformance 959/5000 (19.2%) — Stage 10 in progress (3 categories remaining)
...
```
landin-stage0/
├── Cargo.toml              v0.17.7 (autotests=false — single all_tests target)
├── src/
...
- `docs/develop/v0/api-naming-standard.md` — API naming standard v2.22
...
- `docs/worklog.md` — Worklog mirror (v3.18 §18.4.0) — synced through r202
