...
> This release (v0.83.0) is **v0.1-rc3** — architecture cleanup + API
...
> literal sub-patterns are complete, but deep soundness work (NLL fixpoint,
> region inference, drop elaboration, lifetime elision) remains.
...
| Conformance | 5149 tests (5026 compile + 123 run_ok with real runtime verification) |
