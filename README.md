...
> **Status:** v0.15.2 — Stage 0-7 complete, Stage 8 (v0.2) in progress.
> **2067 tests** + 5 benchmarks. 0 clippy warnings. fmt clean.
...
> - Stage 8: 🔄 In progress (8.1: lifetime elision ✅, 8.2: object safety ✅, 8.3: extern "C" ABI ✅, next: drop elaboration)
>
