...
> **Status:** v0.15.3 — Stage 0-7 complete, Stage 8 (v0.2) in progress.
> **2083 tests** + 5 benchmarks. 0 clippy warnings. fmt clean.
...
> - Stage 8: 🔄 In progress (8.1: lifetime elision ✅, 8.2: object safety ✅, 8.3: extern "C" ABI ✅, 8.4: drop elaboration ✅, next: async/await)
>
