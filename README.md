...
> **Status:** v0.16.3 — Stage 0-9.4 complete. v0.2 roadmap done + §17 docs standardization + v0.1 conformance 247/600.
> **2152 tests** + 5 benchmarks + 247 conformance tests. 0 clippy warnings. fmt clean.
...
> - Stage 9: 🔄 In progress (4/12 sub-stages — v0.1 conformance suite expansion: 247/600)
>
...
| 9 | v0.1 conformance suite expansion | 🔄 In progress (4/12) | +51 rust + +239 conformance |
...
```
landin-stage0/
├── Cargo.toml              v0.16.3 (autotests=false — single all_tests target)
├── src/
...
- **Stage 9** 🔄 In progress (v0.1 conformance suite expansion: 247/600 tests, 4/12 sub-stages done)
...
- `docs/develop/v0/api-naming-standard.md` — API naming standard v2.07
...
- `docs/worklog.md` — Worklog mirror (v3.18 §18.4.0) — synced through r187
