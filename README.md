...
> **Status:** v0.16.9 — Stage 0-9.10 complete. v0.2 roadmap done + §17 docs standardization + v0.1 conformance 547/600.
> **2215 tests** + 5 benchmarks + 547 conformance tests. 0 clippy warnings. fmt clean.
...
> - Stage 9: 🔄 In progress (10/12 sub-stages — v0.1 conformance suite expansion: 547/600)
>
...
| 9 | v0.1 conformance suite expansion | 🔄 In progress (10/12) | +114 rust + +539 conformance |
...
```
landin-stage0/
├── Cargo.toml              v0.16.9 (autotests=false — single all_tests target)
├── src/
...
- **Stage 9** 🔄 In progress (v0.1 conformance suite expansion: 547/600 tests, 10/12 sub-stages done — approaching v0.1 release!)
...
- `docs/develop/v0/api-naming-standard.md` — API naming standard v2.13
...
- `docs/worklog.md` — Worklog mirror (v3.18 §18.4.0) — synced through r193
