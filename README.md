...
> **Status:** v0.17.3 — Stage 0-10.0 complete. CLI --compile/--emit-llvm-ir + runner --mode compile. Conformance 720/5000 (14.4% of v0.1 gate).
> **2261 tests** + 5 benchmarks + 720 conformance tests. 0 clippy warnings. fmt clean.
...
```
landin-stage0/
├── Cargo.toml              v0.17.3 (autotests=false — single all_tests target)
├── src/
...
- `docs/develop/v0/api-naming-standard.md` — API naming standard v2.18
...
- `docs/worklog.md` — Worklog mirror (v3.18 §18.4.0) — synced through r198
