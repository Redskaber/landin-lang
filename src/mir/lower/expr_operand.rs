...
use super::method_resolution::{
    auto_deref_if_ref, find_local_init_expr, find_local_init_type, query_method_self_kind,
    resolve_enum_variant, resolve_inherent_method, resolve_inherent_method_from_hir_expr,
    resolve_trait_method,
};
// Stage 18.132: call lowering functions extracted to call_lower.rs
use super::call_lower::{
    build_dyn_trait_call_terminator, lower_closure_call_to_synthesized, lower_expr_to_place,
};
