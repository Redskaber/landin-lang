...
//!
//! Stage 15.68: `compute_last_use_map` and `compute_ever_read` REMOVED.
...
// Stage 15.68: `compute_last_use_map` REMOVED. True Rust NLL (Stage 15.67)
// uses liveness-based kill exclusively — no last-use map needed.
...
// Stage 15.68: `compute_ever_read` REMOVED. True Rust NLL (Stage 15.67)
// uses liveness-based kill exclusively — no "was ever read" guard needed.
// Per §1.0 原則 9 "正确 > 妥协": the GAP-1 compromise is rejected.
...
mod tests {
    ...
    // Stage 15.68: compute_ever_read tests REMOVED (function removed).
}
