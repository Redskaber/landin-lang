...
pub use stdlib::{
    ...
    stdlib_trait_method_self_kind, stdlib_trait_methods, stdlib_trait_methods_by_self_kind,
    stdlib_traits_with_method, stdlib_traits_with_vtable, stdlib_unary_traits,
    stdlib_vtable_byte_size, stdlib_vtable_emission, stdlib_vtable_emission_summary,
    stdlib_vtable_emissions_for_traits, stdlib_vtable_global_name, stdlib_vtable_layout,
