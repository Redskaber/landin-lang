//! Stage 37.2 (v0.25): Tests for format! {:x} hex formatting.
//!
//! Verifies that `{:x}` format specifier produces lowercase hex output.
//!
...
// ============================================================================
// POSITIVE TESTS — Verify {:x} hex formatting works
// ============================================================================

#[test]
fn stage37_2_pos_hex_single_arg() {
    let src = r#"
fn main() -> i32 {
    let s = format!("{:x}", 255);
    0
...
#[test]
fn stage37_2_pos_hex_with_prefix() {
    let src = r#"
fn main() -> i32 {
    let s = format!("hex={:x}", 16);
    0
}
"#;
    let result = compile(src);
...
#[test]
fn stage37_2_pos_mixed_specifiers() {
    let src = r#"
fn main() -> i32 {
    let s = format!("{} {:x} {:?}", 10, 255, 42);
    0
}
"#;
    let result = compile(src);
...
#[test]
fn stage37_2_pos_hex_large_value() {
    let src = r#"
fn main() -> i32 {
    let s = format!("{:x}", 305419896);
    0
}
"#;
    let result = compile(src);
...
#[test]
fn stage37_2_neg_slice_param_wrong_arg() {
...
#[test]
fn stage37_2_neg_return_mismatch() {
...
#[test]
fn stage37_2_neg_arg_count_mismatch() {
...
#[test]
fn stage37_2_neg_method_not_found() {
...
#[test]
fn stage37_2_neg_self_outside_impl() {
...
#[test]
fn stage37_2_neg_trait_method_arg_count() {
...
#[test]
fn stage37_2_neg_generic_return_mismatch() {
...
#[test]
fn stage37_2_neg_trait_bound_not_satisfied() {
...
#[test]
fn stage37_2_neg_codegen_extern_path() {
    let src = r#"
